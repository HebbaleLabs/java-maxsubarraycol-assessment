...
public class MaxSubarrayColTest {
    ...
    public MaxSubarrayColTest(int[][] input, int expected) {
        this.input = input;
        this.expected = expected;
    }

    @Test
    public void testMaxSubarrayCol() {
        Assert.assertEquals("input:" + Arrays.deepToString(input), expected, MaxSubarrayCol.maxSubarrayCol(input));
    }
}
